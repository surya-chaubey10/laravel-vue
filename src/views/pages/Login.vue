      ...
      <v-card class="auth-card">
        ...
        <v-card-title class="d-flex align-center justify-center py-7">
          <router-link to="/" class="d-flex align-center">
            <v-img
              :src="require('@/assets/images/logos/crickpro.png')"
              max-height="30px"
              max-width="30px"
              alt="logo"
              contain
            ...
            <h2 class="text-2xl font-weight-semibold">Harriss.</h2>
          </router-link>
        </v-card-title>

        <!-- title -->
        <v-card-text>
          <p class="text-2xl font-weight-semibold text--primary mb-2">Welcome to Harriss! 👋🏻</p>
