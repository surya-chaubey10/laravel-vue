<template>
  <v-card min-height="500">
    ...
    <div v-else class="_blan">
      <router-link to="/team/add">
        <v-btn color="primary" text outlined x-large> Add First Team </v-btn>
      </router-link>
    </div>
  </v-card>
</template>
...
export default {
  ...
  mounted() {
    axios
      .get('http://localhost/Cricket/public/dashboard/dashboard-api/team/list')
      .then(res => {
        this.desserts = res.data.data.teams
